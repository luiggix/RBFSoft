...
prec_t hx, hy, over_x, over_y, ep, Re, tol_gmres, tol_ddm, beta, dt;
...
void streamLaplace(Mat& G, const Vec& x, const Vec& y, RBF rbf,
		   RBF_2DX rbf_2dx, RBF_2DY rbf_2dy, prec_t dt)
{
// ----- Wl matrix
...
// ----- Reading data from "input" file	
	...
	input_file >> dataBCast_Flt[9]; // Time step
	input_file.close();
    }
// ----- Broadcast the info to all processors
    cart.comm.Bcast(dataBCast_Int, 8, MPI::INT, 0);    
    cart.comm.Bcast(dataBCast_Flt, 10, MPI::DOUBLE, 0); 
